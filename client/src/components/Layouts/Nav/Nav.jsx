...
import { setNavState, googleOAuthLogin } from '../../../redux/actions';
import { StyledNav, StyledGoogleLogin } from './Nav.style';
          ...
          !this.props.isAuthenticated && (
            <div className="oAuthOptions" style={{ padding: '0 .7rem' }}>
              <StyledGoogleLogin 
                ...
                onSuccess={this.props.googleOAuthLogin}
                onFailure={_ => null}
              >
                <svg
                  version="1.1"
